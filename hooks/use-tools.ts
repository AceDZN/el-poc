...
export const useToolsFunctions = () => {
  ...
  const presentLessonWords = ({ words }: { words: string[] }) => {
    console.log("presentLessonWords", words);
    console.log("t", t("tools.presentLessonWords.success"),);
    toast(t("tools.presentLessonWords.toast") + " 📋", {
      description: t("tools.presentLessonWords.description"),
    });
    return {
      success: true,
      words,
      message: t("tools.presentLessonWords.success"),
    };
  };
