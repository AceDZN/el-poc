export const en = {
  ...
  tools: {
    ...
    //   },
    //   quiz: {
    //     description: 'Say "Start quiz" to start a quiz.',
    //     name: "Quiz",
    //   },
    //   presentLessonWords: {
    //     description: 'Say "Present lesson words" to present lesson words.',
    //     name: "Present Lesson Words",
    //   },
    // },
    clipboard: {
    ...
    presentLessonWords: {
      description: "Present lesson words",
      success: "Presenting lesson words. Explain the words to the user and ask them where to start.",
      toast: "Presenting lesson words",
      failed: "Failed to present lesson words",
    },
    presentQuiz: {
      description: "Present a quiz",
      success: "Quiz presented successfully. Wait for the user to answer.",
      toast: "Quiz time!",
      failed: "Failed to present quiz",
    },
    presentCloze: {
      description: "Present a fill-in-the-blank exercise",
      success: "Fill in the blank exercise presented successfully. Wait for the user to type their answer.",
      toast: "Fill in the blank!",
      failed: "Failed to present fill in the blank exercise",
    },
    presentPhotoQuiz: {
      description: "Present a photo quiz",
      success: "Photo quiz presented successfully. Wait for the user to select an answer.",
      toast: "Photo Quiz Time!",
      failed: "Failed to present photo quiz",
    },
